...
import { InnerCircleInvestmentContent } from "@/components/courses/InnerCircleInvestmentContent"
import { createSupabaseServerClient } from "@/lib/supabase/server"

export default async function InnerCircleInvestmentPage() {
        ...
        <div className="mb-10 rounded-2xl border border-[#1E1E1E] bg-[#111111]/80 p-6 backdrop-blur-sm sm:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-2  text-4xl tracking-tight sm:text-5xl">Inner Circle · Inversiones</h1>
              <p className="mt-3 max-w-2xl text-sm text-[#AAAAAA]">
                Construir un portafolio gestionado con criterio profesional. Cinco módulos secuenciales para diseñar, sostener y defender un sistema completo de inversión.
              </p>
            </div>
        ...
        <div className="mb-10 rounded-2xl border border-[#1E1E1E] bg-[#111111]/80 p-5 sm:p-6">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-[#2A2A2A] bg-[#0F0F0F] p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-[#BBBBBB]">Los módulos no se saltean. Cada decisión del curso se apoya en la lógica del módulo anterior.</p>
            </div>
            <div className="rounded-xl border border-[#2A2A2A] bg-[#0F0F0F] p-4">
              <h3 className="text-sm font-semibold uppercase tracking-[0.14em] text-white">Aplicación</h3>
              <p className="mt-2 text-sm leading-relaxed text-[#BBBBBB]">No leas como entretenimiento. Documentá mandato, tesis, log y revisiones reales mientras avanzás.</p>
            </div>
            <div className="rounded-xl border border-[#2A2A2A] bg-[#0F0F0F] p-4">
              <h3 className="text-sm font-semibold uppercase tracking-[0.14em] text-white">Objetivo</h3>
              <p className="mt-2 text-sm leading-relaxed text-[#BBBBBB]">Cerrar la disciplina con un método profesional para construir, gestionar y evaluar un portafolio vivo.</p>
            </div>
          </div>
        </div>

        <InnerCircleInvestmentContent />
